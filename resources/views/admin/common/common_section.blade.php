        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="HomeSection1">
                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                    data-bs-target="#home_section_1" aria-expanded="true"
                    aria-controls="home_section_1">
                ...
                <div class="accordion-body">
                    ...
                    @csrf
                            ...
                            <div class="col-3">
                                <div class="form-check form-switch form-switch-md" style="padding-left: 3em;">
                                    ...
                                    <input class="form-check-input code-switcher" type="checkbox"
                                        id="dropdown-base-example" name="status" {{ isset($section1) ? (($section1->status == 1) ? 'checked' : '') : 'checked' }}>
                                </div>
                            </div>
                        </div>
                        <div class="row gy-4">
                        ...
                        @for($i=1; $i<=3; $i++)
                            ...
                            @php $sub_section1 = $section1->subSection[$i-1] ?? false  @endphp
                                    ...
                                    <div id="sub_sec{{$i}}"
                                        ...
                                        <div class="accordion-body">
                                            <div class="form-check form-switch form-switch-md" style="padding-left: 3em;">
                                                <label for="dropdown-base-example" class="form-label text-muted">Status</label>
                                                <input class="form-check-input code-switcher" type="checkbox"
                                                    id="dropdown-base-example" name="sub_section[{{$i}}][status]" {{ isset($sub_section1) ? (($sub_section1->status == 1) ? 'checked' : '') : 'checked' }}>
                                            </div>
