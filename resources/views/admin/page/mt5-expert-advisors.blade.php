                            ...
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control {{ $errors->has('video_url') ? 'is-invalid' : '' }}" value="{{ old('video_url', isset($section3) ? 'https://www.youtube.com/watch?v='.$section3->getRawOriginal('video_url') : '') }}" placeholder="Youtube video URL" id="video_url" name="video_url">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="form-check form-switch form-switch-md" style="padding-left: 3em;">
                                    <label for="customSwitchsizelg" class="form-label text-muted">Status</label>
                                    <input class="form-check-input code-switcher" type="checkbox"
                                        id="customSwitchsizelg" name="status" checked="{{ isset($section5) ? (($section5->status == 1) ? true : false) : true }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row gy-4 mt-1">
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text" id="basic-addon3">https://www.youtube.com/</span>
                                        <input type="text" class="form-control {{ $errors->has('video_url') ? 'is-invalid' : '' }}" value="{{ old('video_url', isset($section5) ? 'https://www.youtube.com/watch?v='.$section5->getRawOriginal('video_url') : '') }}" placeholder="Youtube video URL" id="video_url" name="video_url">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="accordion-body">
                    ...
                    @csrf
                        ...
                        <div class="row gy-4 mt-1">
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text" id="basic-addon3">https://www.youtube.com/</span>
                                        <input type="text" class="form-control {{ $errors->has('video_url') ? 'is-invalid' : '' }}" value="{{ old('video_url', isset($section6) ? 'https://www.youtube.com/watch?v='.$section6->getRawOriginal('video_url') : '') }}" placeholder="Youtube video URL" id="video_url" name="video_url">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        @for($i=1; $i<=3; $i++)
                            ...
                            @php $sub_section6 = $section6->subSection[$i-1] ?? ''  @endphp
        ...
        <div class="accordion-item">
            ...
            <div id="sec_7" class="accordion-collapse collapse"
                ...
                <div class="accordion-body">
                    ...
                    <form action="{{ route('admin.save_section', ['sec_no' => 7]) }}" method="post">
                    @csrf
                        <input type="hidden" name="page_id" value="{{$page_id}}">
        ...
        <div class="accordion-item">
            <h2 class="accordion-header" id="Sec9">
                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                    ...
                    aria-controls="sec_9">
                    <i class="ri-global-line me-2"></i>Link Section
                </button>
            </h2>
            <div id="sec_9" class="accordion-collapse collapse"
                aria-labelledby="Sec9" data-bs-parent="#sec9">
                <div class="accordion-body">
    ...
    <div class="accordion custom-accordionwithicon accordion-secondary mt-2" id="sec10">
        <div class="accordion-item">
            <h2 class="accordion-header" id="Sec10">
                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                    data-bs-target="#sec_10" aria-expanded="true"
                    aria-controls="sec_10">
                    <i class="ri-global-line me-2"></i>Note Section
                </button>
            </h2>
            <div id="sec_10" class="accordion-collapse collapse"
                aria-labelledby="Sec10" data-bs-parent="#sec10">
                <div class="accordion-body">
                    @php isset($section) ? $section10 = $section->where('section_no', 10)->first() : '' @endphp
                    <form action="{{ route('admin.save_section', ['sec_no' => 10]) }}" method="post">
                    @csrf
                        <input type="hidden" name="page_id" value="{{$page_id}}">
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="form-check form-switch form-switch-md" style="padding-left: 3em;">
                                    <label for="customSwitchsizelg" class="form-label text-muted">Status</label>
                                    <input class="form-check-input code-switcher" type="checkbox"
                                        id="customSwitchsizelg" name="status" {{ isset($section10) ? (($section10->status == 1) ? 'checked' : '') : 'checked' }}>
                                </div>
                            </div>
                        </div>
