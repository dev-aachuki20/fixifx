        ...
        <div class="accordion-item">
            ...
            <h2 class="accordion-header" id="Sec1">
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#sec_1" aria-expanded="true" aria-controls="sec_1">
                    <i class="ri-global-line me-2"></i>{{ isset($section1) ? $section1->en_title : 'Sub header section'}}
                </button>
            </h2>
            <div id="sec_1" class="accordion-collapse collapse" aria-labelledby="Sec1" data-bs-parent="#sec1">
                <div class="accordion-body">
                    <form action="{{ route('admin.save_section', ['sec_no' => 1]) }}" method="post" enctype="multipart/form-data">
                        ...
                        @php
                        $i = 0;
                        $sub_section1 = $section1->subSection[$i] ?? false;
                        @endphp
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="sub_sec_{{$i}}">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#sub_sec{{$i}}" aria-expanded="false" aria-controls="sub_sec{{$i}}">
                                        <i class="ri-global-line me-2"></i>Point
                                    </button>
                                </h2>
                                <div id="sub_sec{{$i}}" class="accordion-collapse collapse" aria-labelledby="sub_sec_{{$i}}" data-bs-parent="#sub_sec_{{$i}}">
                                    <div class="accordion-body">
                                        <div class="form-check form-switch form-switch-md" style="padding-left: 3em;">
                                            ...
                                            <input class="form-check-input code-switcher" type="checkbox" id="dropdown-base-example" name="sub_section[{{$i}}][status]" {{ $sub_section1 ? (($sub_section1->status == 1) ? 'checked' : '') : 'checked' }}>
                                        </div>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-xxl-6 col-md-6">
                                                <div>
                                                    <label for="dec" class="form-label">Description (English)</label>
                                                    <textarea name="sub_section[{{$i}}][en_desc]" class="ckeditor_custom" id="description" cols="30" rows="10">{{ old('en_desc', isset($sub_section1) ? $sub_section1->en_desc : '') }}</textarea>
                                                </div>
                                            </div>
                                            <br>
                                            <div class="col-xxl-6 col-md-6">
                                                <div>
                                                    <label for="dec" class="form-label">Description (Japanese)</label>
                                                    <textarea name="sub_section[{{$i}}][ja_desc]" class="ckeditor_custom" id="description" cols="30" rows="10">{{ old('ja_desc', isset($sub_section1) ? $sub_section1->ja_desc : '') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        @endif
                    ...
                    <form action="{{ route('admin.save_section', ['sec_no' => 2]) }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-xxl-12 col-md-12">
                                <div>
                                    <label for="dec" class="form-label">Table (English)</label>
                                    <textarea name="en_desc" class="ckeditor_custom lg-ckeditor" id="description" cols="30" rows="50">{{ old('en_desc', isset($section2) ? $section2->en_desc : '') }}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-xxl-12 col-md-12">
                                <div>
                                    <label for="dec" class="form-label">Table (Japanese)</label>
                                    <textarea name="ja_desc" class="ckeditor_custom lg-ckeditor" id="description" cols="30" rows="50">{{ old('ja_desc', isset($section2) ? $section2->ja_desc : '') }}</textarea>
                                </div>
                            </div>
                        </div>
