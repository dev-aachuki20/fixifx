                        ...
                        <div class="row gy-4 mt-1">
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text" id="basic-addon3">https://www.youtube.com/</span>
                                        <input type="text" class="form-control {{ $errors->has('video_url') ? 'is-invalid' : '' }}" value="{{ old('video_url', isset($section4) ? 'https://www.youtube.com/watch?v='.$section4->getRawOriginal('video_url') : '') }}" placeholder="Youtube video URL" id="video_url" name="video_url">
                                    </div>
                                </div>
                            </div>
                        </div>
