                                                    ...
                                                    <div class="col-3">
                                                        <div class="form-check form-switch form-switch-md" style="padding-left: 3em;">
                                                            ...
                                                            <input class="form-check-input code-switcher status" type="checkbox"
                                                                id="customSwitchsizelg" name="section[{{$i}}][status]" {{ isset(${'section'.($i+1)}) ? ((${'section'.($i+1)}->status == 1) ? "checked" : '') : "checked" }}>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row gy-4 mt-1">
                                                    <div class="col-xxl-6 col-md-6">
                                                        <div>
                                                            ...
                                                            <input type="file" name="section[{{$i}}][image]" class="form-control">
                                                        </div>
                                                    </div>
                                                    @if(isset(${'section'.($i+1)}) && ${'section'.($i+1)}->image)
                                                    <div class="col-xxl-6 col-md-6 imageDiv">
                                                        <img src="{{ ${'section'.($i+1)}->image }}" alt="" width="50px" height="50px" class="image" loading="lazy">
                                                    </div>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-3">
                                                    <div class="form-check form-switch form-switch-md" style="padding-left: 3em;">
                                                        <label for="customSwitchsizelg" class="form-label text-muted">Status</label>
                                                        <input class="form-check-input code-switcher status" type="checkbox"
                                                            id="customSwitchsizelg" name="section[0][status]" {{ isset($section0) ? (($section0->status == 1) ? 'checked' : '') : 'checked' }}>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row gy-4 mt-1">
