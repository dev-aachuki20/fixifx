                            ...
                            <div class="accordion-body">
                                    ...
                                    <div class="col-xxl-6 col-md-6">
                                        ...
                                        <div class="row gy-4 mt-1 mb-1">
                                            <div class="my-2">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="section_type s1 form-check-input" type="radio" name="section[0][section_type]" value="0" dataid="0" checked="checked">
                                                    <label class="form-check-label" for="ctrader">
                                                        C-Trader
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="section_type s2 form-check-input" type="radio" name="section[0][section_type]" value="1" dataid="0">
                                                    <label class="form-check-label" for="fixi">
                                                        FiXi
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="section_type form-check-input" type="radio" name="section[0][section_type]" value="2" dataid="0">
                                                    <label class="form-check-label" for="MetaTrader5">
                                                        MetaTrader5
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="section_type form-check-input" type="radio" name="section[0][section_type]" value="3" dataid="0">
                                                    <label class="form-check-label" for="mobileapp">
                                                        Mobile APP
                                                    </label>
                                                </div>
                                    ...
                                    <div class="col-xxl-6 col-md-6">
                                        <div class="row gy-4 mt-1 mb-1">
                                            <div class="my-2">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="section_type_jp s3 form-check-input" type="radio" name="section[0][section_type_jp]" value="0" dataid="0" checked="checked">
                                                    <label class="form-check-label" for="C-トレーダー">
                                                        C-トレーダー
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="section_type_jp s4 form-check-input" type="radio" name="section[0][section_type_jp]" value="1" dataid="0">
                                                    <label class="form-check-label" for="フィキシ">
                                                        フィキシ
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="section_type_jp form-check-input" type="radio" name="section[0][section_type_jp]" value="2" dataid="0">
                                                    <label class="form-check-label" for="メタトレーダー5">
                                                        メタトレーダー5
                                                    </label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="section_type_jp form-check-input" type="radio" name="section[0][section_type_jp]" value="3" dataid="0">
                                                    <label class="form-check-label" for="モバイルアプリ">
                                                        モバイルアプリ
                                                    </label>
                                                </div>
                                ...
                                <div class="row gy-4 mt-1">
                                    ...
                                    <div class="col-xxl-6 col-md-6">
                                        <div class="my-2">
                                            <div class="form-check form-check-inline">
                                                <input class="file type form-check-input" type="radio" name="section[0][type]" value="1" dataid="0" checked="checked">
                                                <label class="form-check-label" for="file">
                                                    Upload File
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="link type form-check-input" type="radio" name="section[0][type]" value="2" dataid="0" checked="checked">
                                                <label class="form-check-label" for="link">
                                                    Enter Link
                                                </label>
                                            </div>
                                        ...
                                        <div class="row gy-2 mt-1">
                                            <div class="col-xxl-6 col-md-6">
                                                <input type="hidden" name="section[0][image]" id="section[0][image]" value="{{ isset($section2) ? $section2->orignal_image : '' }}">
                                                <label for="title" class="form-label file_label" id="label_tag_0">{{ isset($section2) && str_contains($section2->getRawOriginal('image'), 'http') ? 'Enter Link' : 'Upload File' }}</label>
                                                <input type="{{str_contains(isset($section2) && $section2->getRawOriginal('image'), 'http')?'text':'file'}}" name="section[0][image]" class="image form-control" id="file_tag_0" value="{{ isset($section2) ? $section2->orignal_image : '' }}">
                                            </div>
                                            @if(isset($section2) && $section2->image)
                                            <div class="imageDiv col-xxl-6 col-md-6">
                                                <a download class="btn btn-primary mt-4" href="{{str_contains($section2->getRawOriginal('image'), 'http')?$section2->getRawOriginal('image'):$section2->image}}" name="section[0][image]" value="{{ $section2->getRawOriginal('image')}}" rel="noreferrer noopener">Download</a>
                                            </div>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xxl-6 col-md-6">
                                        <div class="my-2">
                                            <div class="form-check form-check-inline">
                                                <input class="file1 ja_type form-check-input" type="radio" name="section[0][ja_type]" value="1" dataid="0" checked="checked">
                                                <label class="form-check-label" for="file1">
                                                    ファイルをアップロードする
                                                </label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="link1 ja_type form-check-input" type="radio" name="section[0][ja_type]" value="2" dataid="0" checked="checked">
                                                <label class="form-check-label" for="link1">
                                                    リンクを入力してください
                                                </label>
                                            </div>
                                        ...
                                        <div class="row gy-2 mt-1">
                                            <div class="col-xxl-6 col-md-6">
                                                <input type="hidden" name="section[0][ja_image]" id="section[0][ja_image]" value="{{ isset($section2) ? $section2->orignal_ja_image : '' }}">
                                                <label for="title" class="form-label file1_label" id="label1_tag_0">{{ isset($section2) && str_contains($section2->getRawOriginal('ja_image'), 'http') ? 'リンクを入力してください' : 'ファイルをアップロードする' }}</label>
                                                <input type="{{ isset($section2) && str_contains($section2->getRawOriginal('ja_image'), 'http') ? 'text' : 'file' }}" name="section[0][ja_image]" class="ja_image form-control" id="file1_tag_0" value="{{ isset($section2) ? $section2->orignal_ja_image : '' }}">
                                            </div>
                                            @if(isset($section2) && $section2->ja_image)
                                            <div class="ja_imageDiv col-xxl-6 col-md-6">
                                                <a download class="btn btn-primary mt-4" href="{{ str_contains($section2->getRawOriginal('ja_image'), 'http') ? $section2->getRawOriginal('ja_image') : $section2->ja_image }}" name="section[0][ja_image]" value="{{ $section2->getRawOriginal('ja_image') }}" rel="noreferrer noopener">Download</a>
                                            </div>
                                            @endif
                                        </div>
                                    </div>
