                                    ...
                                    <div id="sub_sec{{$i}}" class="accordion-collapse collapse" aria-labelledby="sub_sec_{{$i}}" data-bs-parent="#sub_sec_{{$i}}">
                                        <div class="accordion-body">
                                            <div class="form-check form-switch form-switch-md" style="padding-left: 3em;">
                                                ...
                                                <input class="form-check-input code-switcher" type="checkbox" id="dropdown-base-example" name="status" {{ isset(${'section'.($i)}) ? ((${'section'.($i)}->status == 1) ? 'checked' : '') : 'checked' }}>
                                            </div>
                                            <div class="row gy-4">
                                                ...
                                                <div class="col-xxl-6 col-md-6">
                                                   <input type="hidden" name="image" value="{{${'section'.($i)}->getRawOriginal('image')}}">
                                                    <img src="{{ ${'section'.$i}->image }}" alt="" loading="lazy" width="100px" height="100px">
                                                </div>
                                                @endif
                                            </div>
