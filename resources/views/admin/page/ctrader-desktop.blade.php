                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="form-check form-switch form-switch-md" style="padding-left: 3em;">
                                    <label for="customSwitchsizelg" class="form-label text-muted">Status</label>
                                    <input class="form-check-input code-switcher" type="checkbox"
                                        id="customSwitchsizelg" name="status" checked="{{ isset($section8) ? (($section8->status == 1) ? true : false) : true }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="form-check form-switch form-switch-md" style="padding-left: 3em;">
                                    <label for="customSwitchsizelg" class="form-label text-muted">Status</label>
                                    <input class="form-check-input code-switcher" type="checkbox"
                                        id="customSwitchsizelg" name="status" checked="{{ isset($section9) ? (($section9->status == 1) ? true : false) : true }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="form-check form-switch form-switch-md" style="padding-left: 3em;">
                                    <label for="customSwitchsizelg" class="form-label text-muted">Status</label>
                                    <input class="form-check-input code-switcher" type="checkbox"
                                        id="customSwitchsizelg" name="status" checked="{{ isset($section10) ? (($section10->status == 1) ? true : false) : true }}">
                                </div>
                            </div>
                        </div>
    ...
    <div class="accordion custom-accordionwithicon accordion-secondary mt-2" id="sec11">
        <div class="accordion-item">
            <h2 class="accordion-header" id="Sec11">
                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                    data-bs-target="#sec_11" aria-expanded="true"
                    aria-controls="sec_11">
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="form-check form-switch form-switch-md" style="padding-left: 3em;">
                                    <label for="customSwitchsizelg" class="form-label text-muted">Status</label>
                                    <input class="form-check-input code-switcher" type="checkbox"
                                        id="customSwitchsizelg" name="status" checked="{{ isset($section11) ? (($section11->status == 1) ? true : false) : true }}">
                                </div>
                            </div>
                        </div>
