    ...
    <div class="accordion custom-accordionwithicon accordion-secondary mt-2" id="sec2">
        <div class="accordion-item">
            ...
            <div id="sec_2" class="accordion-collapse collapse"
                aria-labelledby="Sec3" data-bs-parent="#sec2">
                                    ...
                                    <div id="sub_sec{{$i}}"
                                        ...
                                        <div class="accordion-body">
                                            <div class="form-check form-switch form-switch-md" style="padding-left: 3em;">
                                                ...
                                                <input class="form-check-input code-switcher" type="checkbox"
                                                    id="dropdown-base-example" name="sub_section[{{$i}}][status]"  {{ isset($sub_section2->status) ? (($sub_section2->status == 1) ? 'checked' : '') : 'checked' }}>
                                            </div>
                ...
                <div class="accordion-body">
                    ...
                    @csrf
                        ...
                        <div class="row mt-4">
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    ...
                                    <input type="text" class="form-control" id="en_short_text" name="en_short_text" value="{{ old('en_short_text', isset($section3) ? $section3->en_short_text : '') }}">
                                </div>
                            </div>
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    <label for="title" class="form-label">Button Text (Japanese)</label>
                                    <input type="text" class="form-control" id="ja_short_text" name="ja_short_text" value="{{ old('ja_short_text', isset($section3) ? $section3->ja_short_text : '') }}">
                                </div>
                            </div>
                        </div>
                        <div class="row mt-4">
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control {{ $errors->has('video_url') ? 'is-invalid' : '' }}" value="{{ old('video_url', isset($section3) ? $section3->getRawOriginal('video_url') : '') }}" placeholder="Add Button Link" id="video_url" name="video_url">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row mt-4">
                            ...
                            @if(isset($section3->image) && $section3->image)
                            <div class="col-xxl-6 col-md-6">
                                <div>
                                   <input type="hidden" name="image" value="{{ $section3->getRawOriginal('image')}}">
                                    <img src="{{ $section3->image }}" alt="" height="100px" width="100px" loading="lazy">
                                </div>
                            </div>
                            @endif
                        </div>                 
    ...
    <div class="accordion custom-accordionwithicon accordion-secondary mt-2" id="sec4">
        <div class="accordion-item">
            ...
            <div id="sec_4" class="accordion-collapse collapse"
                aria-labelledby="Sec3" data-bs-parent="#sec4">
                <div class="accordion-body">
                    ...
                    @csrf
                        ...
                        @for($i=1; $i<=4; $i++)
                            ...
                            @php $sub_section3 = $section4->subSection[$i-1] ?? ''  @endphp
                            @if($sub_section3)
                                    ...
                                    <div id="sub_sec{{$i}}"
                                        ...
                                        <div class="accordion-body">
                                            <div class="form-check form-switch form-switch-md" style="padding-left: 3em;">
                                                <label for="dropdown-base-example" class="form-label text-muted">Status</label>
                                                <input class="form-check-input code-switcher" type="checkbox"
                                                    id="dropdown-base-example" name="sub_section[{{$i}}][status]" {{ isset($sub_section3->status) ? (($sub_section3->status == 1) ? 'checked' : '') : 'checked' }}>
                                            </div>
