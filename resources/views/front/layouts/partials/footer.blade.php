        ...
        <div class="container">
          <div class="d-flex flex-wrap">
            ...
            <div class="footer-social">
              ...
              <ul class="border-bg">
                <li><a href="{{ getSettingValue('twitter_link') }}"><img src="{{ asset('fixifx/images/icons/twitter.svg') }}" alt="twitter"></a></li>
                <li><a href="{{ getSettingValue('fb_link') }}"><img src="{{ asset('fixifx/images/icons/facebook.svg') }}" alt="facebook"></a></li>
                <li><a href="{{ getSettingValue('youtube_link') }}"><img src="{{ asset('fixifx/images/icons/youtube.svg') }}" alt="youtube"></a></li>
                <li><a href="{{ getSettingValue('insta_link') }}"><img src="{{ asset('fixifx/images/icons/instagram.svg') }}" alt="instagram"></a></li>  
              </ul>
            </div>
          </div>
        </div>
            ...
            <div class="col-lg-9 col-md-6 col-sm-12">
              <div class="footer-links-outer">
                ...
                <div class="footer-links-inner">
                   @if($sub_menu->get(14))
                   <div class="footer-links">
                    @if($sub_menu->get(14) && $sub_menu->get(14)->{config('app.locale').'_name'})<h5 class="footer-heading text-white">{{ $sub_menu->get(14)->{config('app.locale').'_name'} }}</h5>@endif
                        @if($sub_menu->get(14))
                        <ul>
                   ...
                   <div class="footer-links">
                    ...
                    @if($menu->get(2)->{config('app.locale').'_name'})<h5 class="footer-heading text-white">{{ $menu->get(2)->{config('app.locale').'_name'} }}</h5>@endif
                    <ul>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <div class="footer-warning-inner border-bg">
                <p>{{ getSettingValue('risk_title_'.config('app.locale')) }}: {{ getSettingValue('risk_desc_'.config('app.locale')) }}</p></div>
            </div>
          </div>
        </div>
      </div>
