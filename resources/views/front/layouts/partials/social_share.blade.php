            ...
            <li class="socialMedia-box-link telegram_icon">
                <a href="https://telegram.me/share/url?url={{url()->current()}}" target="_blank">
                    <svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M6.35659 8.89745L6.08862 12.6666C6.47202 12.6666 6.63807 12.5019 6.83719 12.3042L8.63472 10.5863L12.3594 13.314C13.0425 13.6947 13.5237 13.4942 13.708 12.6855L16.1529 1.22945L16.1535 1.22877C16.3702 0.218974 15.7884 -0.175901 15.1228 0.0718237L0.75207 5.57375C-0.228705 5.95445 -0.213855 6.5012 0.585345 6.74892L4.25937 7.8917L12.7934 2.55177C13.195 2.28582 13.5602 2.43297 13.2598 2.69892L6.35659 8.89745Z"
                            fill="white"></path>
                    </svg>
                </a>
            </li>
            ...
            <li class="socialMedia-box-link linkedin_icon">
                <a href="https://www.linkedin.com/shareArticle?url={{url()->current()}}" target="_blank">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M15.9959 16L15.9999 15.9993V10.1312C15.9999 7.26055 15.3819 5.04919 12.0259 5.04919C10.4125 5.04919 9.32986 5.93454 8.88785 6.77388H8.84119V5.3172H5.65918V15.9993H8.97252V10.7099C8.97252 9.31723 9.23652 7.97056 10.9612 7.97056C12.6605 7.97056 12.6859 9.5599 12.6859 10.7992V16H15.9959Z"
                            fill="white"></path>
                        <path d="M0.26416 5.31848H3.5815V16.0006H0.26416V5.31848Z" fill="white"></path>
                        <path
                            d="M1.92134 0C0.860669 0 0 0.860675 0 1.92135C0 2.98203 0.860669 3.8607 1.92134 3.8607C2.98201 3.8607 3.84268 2.98203 3.84268 1.92135C3.84201 0.860675 2.98134 0 1.92134 0Z"
                            fill="white"></path>
                    </svg>
                </a>
            </li>
