                    ...
                    <div class="uk-width-2-3@m">
                        <div class="inner-content">
                            ...
                            <div class="inner-features-wrap ">
                                ...
                                <div class="uk-grid uk-grid-column-medium uk-child-width-1-3@s uk-child-width-1-2 uk-margin-medium-top uk-margin-medium-bottom"
                                    data-uk-grid="">
                            ...
                            @if($section4)
                            <div class="uk-position-relative uk-visible-toggle in-profit-7 uk-margin-medium-top uk-margin-medium-bottom"
                                    ...
                                    <div class="uk-slider-items uk-child-width-1-2@s uk-child-width-1-2@m uk-grid-small uk-grid">    
                                        ...
                                        <div>
                                            <article class="custom_box custom_box_shadow m-0">
                                                <img loading="lazy" class="uk-border-rounded" src="{{ $sub_sec->image }}"
                                                    data-src="{{ $sub_sec->image }}" alt="profit-news" width="340"
