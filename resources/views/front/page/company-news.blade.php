@php
    $keywords_jp = 'FiXi,フィクシー,お知らせ,ニュース';
    $description_jp = 'FiXi FX（フィクシー）に関するお知らせ･ニュース一覧ページです。';
@endphp
                        ...
                        <div class="inner-content">
                            ...
                            <div class="inner-features-wrap ">
                                <div class="forex-paragraf-info forex-instruments-info">
                                    <ul class="uk-list uk-list-divider blog-list-wrap">
                                        ...
                                        <li class="blog-widget-card">
                                            <div class="uk-flex uk-grid-column-small uk-grid-row-large uk-flex-between@s align-items-center my-4" uk-grid>
                                                <div class="uk-width-1-3@s uk-margin-left@s">
                                                    <div class="blog-img">
                                                        <img src="{{ $article->image }}" data-src="{{ $article->image }}" alt="{{ config('app.locale') == 'ja' ? 'FiXi FX（フィクシー）' : 'FiXi FX' }}" loading="lazy" data-uk-img>
                                                    </div>
                                                </div>
