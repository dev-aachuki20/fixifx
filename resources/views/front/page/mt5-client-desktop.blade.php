        ...
        <div class="risk-management-herobox mt5-riskinner ptb-50">
            <div class="row align-items-center">
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="imgbox">
                        @if($section6->image)
                        <img class="img-fluid" src="{{ $section6->image ? $section6->image : asset('fixifx/images/Platforms-01.png') }}" alt="{{ config('app.locale') == 'ja' ? 'Meta Trader 5 (MT5) Windows版 - FiXi FX（フィクシー）' : 'Meta Trader 5 (MT5) Windows - FiXi FX' }}">
                        @endif
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-6 mt-5 mt-md-0">
            ...
            <div class="system-requirements-inner mt5-inner-system">
                <div class="row">
                    <div class="col-12 col-md-4 col-lg-4">
                        <div class="img-box">
                            <img class="img-fluid" src="{{$section5->image ? $section5->image : asset('fixifx/images/platforms01.svg')}}" alt="">
                        </div>
                    </div>
                    <div class="col-12 col-md-8 col-lg-8">
                        <div class="contentbox">
                            <h4 class="mb-4">{{ $section5->{config('app.locale').'_title'} }}</h4>
